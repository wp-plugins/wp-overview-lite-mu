...
Version: 2010.0903.1830-MU
Author: sLa
Author URI: http://wordpress.org/extend/plugins/profile/sla/
 *
 * Development Release: Version 2010 Build 0903-BUGFIX Revision 1830-MU
...
<strong>Limit </strong><span><?php echo$this->memory['wpo-limit'].'M *'?></span></li><br />
...
<strong>Deprecated </strong><span><?php echo(int)E_DEPRECATED?></span></li><br />
<li><strong>SQL Uptime</strong>: <span><?php echo$uptime_string?></span></li><br />
<li><strong>Default Theme</strong>: <span><?php echo WP_DEFAULT_THEME?></span><em> (since wp-3.0)</em></li>
...
<li><strong>Trash</strong>: <span><?php echo(int)WP_TRASH?></span> <strong>Empity</strong> <span><?php echo(int)EMPTY_TRASH_DAYS.' days'?></span><em> (since wp-2.9)</em></li><br />
<li><strong><u>NETWORK - MU~LTI-SITE</u></strong></li>
<li><strong>404</strong>: <span><?php echo _e(NOBLOGREDIRECT)?></span></li>
<li><strong>Network</strong>: <span><?php echo _e(WP_ALLOW_MULTISITE)?></span><em> (since wp-3.0)</em> <strong>Multi-site</strong>: <span><?php echo _e(MULTISITE)?></span><em> (since wp-3.0.1)</em></li>
