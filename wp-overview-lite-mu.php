...
function wpomu_footer_log(){echo"\n<!--Plugin WP Overview (lite) MU 2010.1010.1809-MU Active-->";}add_action('wp_head','wpomu_footer_log');add_action('wp_footer','wpomu_footer_log');?><?php
