...
Version: 2010.0618.1804-MU
Author: sLa
Author URI: http://wordpress.org/extend/plugins/profile/sla/
 *
 * Development Release: Version 2010 Build 0618-BUGFIX Revision 1804-MU
...
}function add_dashboard(){wp_add_dashboard_widget('wp_overview_lite_dashboard','Overview',array(&$this,'dashboard_output'));}}add_action('plugins_loaded',create_function('','$memory=new wp_overview_lite();'));}?>